...
% 
% save feature_data X_combinedlda mean_X project_combinedlda

load feature_data
% matching and recognition for ear data base
% load imagetest_data;
[filename, pathname] = uigetfile('*.jpg', 'Pick an jpg-file');
...
X_im = imread([pathname filename]);
X_test = double(reshape(X_im,197*100,1));
min=1;
